...
int main()
{
  ...
  //Mat img = cv::imread("C:/Users/Public/Pictures/Sample Pictures/Testpattern2.png", CV_LOAD_IMAGE_COLOR);
  //Mat img = cv::imread("C:/Users/Public/Pictures/Sample Pictures/Testpattern3.png", CV_LOAD_IMAGE_COLOR);
